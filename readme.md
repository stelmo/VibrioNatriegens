...
The model is composed of 1418 reactions, 1022 metabolites, and 990 genes. 
...
| Transport reactions | 239 |
| Exchange reactions | 189 |
| Metabolic reactions with GRRs | 750 |
| Transport reactions with GRRs | 119 |
...
These issues will be fixed in due course, however pull requests are welcome!
