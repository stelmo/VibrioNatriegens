...
function curate!(model)
    ...
    rename(model, "R04594", "N1-(5-Phospho-alpha-D-ribosyl)-5,6-dimethylbenzimidazole hydrolase")
    ...
    rename(model, "R06558", "adenosylcobinamide kinase / adenosylcobinamide-phosphate guanylyltransferase")
