...
rxns = (
    ...
    (rhea_id = 21648, name = "Prephenate dehydratase", isozymes = [[(1, "A0A1B1E9S4"),],], subsystem = subsystem,), #4.2.1.51 - this and the next rxn form a bifunctional complex
    (rhea_id = 13897, name = "Chorismate mutase", isozymes = [[(1, "A0A1B1E9S4"),],], subsystem = subsystem,), #5.4.99.5
    ...
    (rhea_id = 21540, name = "N-(5'-phosphoribosyl)anthranilate isomerase", isozymes = [[(1, "A0A1B1ED64"),],], subsystem = subsystem,), #5.3.1.24 - this and the rxn below are 1 multifunctional fusion protein
    (rhea_id = 23476, name = "Indole-3-glycerol phosphate synthase", isozymes = [[(1, "A0A1B1ED64"),],], subsystem = subsystem,), #4.1.1.48
)

#=
These ECs were already recorded in other subsystems: EC4.2.1.20, EC2.6.1.9 and EC1.14.16.1
=#
