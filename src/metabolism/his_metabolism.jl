...
rxns = (
    ...
    (rhea_id = 14465, name = "Imidazoleglycerol-phosphate dehydratase", isozymes = [[(1, "A0A1B1EBE7"),],], subsystem = subsystem,), #4.2.1.19 part of Histidine biosynthesis bifunctional protein HisB
    (rhea_id = 11040, name = "Histidinol-phosphatase", isozymes = [[(1, "A0A1B1EBE7"),],], subsystem = subsystem,), #3.1.3.15 part of Histidine biosynthesis bifunctional protein HisB
