...
rxns = (
    ...
    (rhea_id = 14729, name = "Fructose-bisphosphate aldolase", isozymes = [[(1, "A0A1B1EEZ8"),],], subsystem = subsystem,), # 4.1.2.12
    ...
    (rhea_id = 15901, name = "2,3-bisphosphoglycerate-independent phosphoglycerate mutase", isozymes = [[(1, "A0A1B1EFI9"),],], subsystem = subsystem,), #5.4.2.12
    ...
    (rhea_id = 17017, name = "pyruvate dehydrogenase E2", isozymes = [[(1, "A0A1B1EES8"),],], subsystem = subsystem,), # 2.3.1.12 same as TCA
    (rhea_id = 23176, name = "Acetyl-coenzyme A synthetase", isozymes = [[(1, "A0A1B1EFQ7"),],], subsystem = subsystem,), # 6.2.1.1
    (rhea_id = 15045, name = "Dihydrolipoyl dehydrogenase", isozymes = [[(1, "A0A1B1EET9"),],], subsystem = subsystem,), # 1.8.1.4 same as TCA
)
