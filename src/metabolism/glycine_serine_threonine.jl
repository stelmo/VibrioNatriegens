...
rxns = (
    ...
    (rhea_id = 22108, name = "L-threonine dehydratase", isozymes = [[(4, "A0A1B1EG77"),],], subsystem = "$subsystem, Valine, Leucine and Isoleucine Degradation",), #EC 4.3.1.19
...
These ECs were present but not included in rxns:
    ...
    (rhea_id = 10532, name = "Tryptophan synthase beta chai", isozymes = [[(4, "A0A1B1ED60"),], [(4, "A0A1B1ED72"),], [(4, "A0A1B1EJ76"),],], subsystem = "$subsystem, Phenylalanine, Tyrosine and Tryptophan Biosynthesis",), #EC 4.2.1.20 unknown subunit information 
...
These ECs were already recorded in other subsystem files: EC5.4.2.12, EC1.1.1.95, EC4.3.1.17, EC1.8.1.4, EC1.2.1.11, EC1.1.1.3, EC2.7.2.4, EC2.6.1.52
=#
