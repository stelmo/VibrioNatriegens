...
rxns = (
    ...
    (rhea_id = 23252, name = "Ribonucleoside-diphosphate reductase", isozymes = [[(1, "A0A1B1ED46"),], [(1, "A0A1B1ED65"),], [(1, "A0A5B9N9N9"),], [(1, "A0A5B9NCJ5"),],], subsystem = subsystem,), #1.17.4.1
    ...
    (rhea_id = 12484, name = "5'-nucleotidase SurE", isozymes = [[(1, "A0A1B1EEY0"),], [(1, "A0A1B1ELI9"),],], subsystem = subsystem,), #3.1.3.5
