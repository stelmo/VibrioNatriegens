...
rxns = (
    ...
    (rhea_id = 10932, name = "Argininosuccinate synthase", isozymes = [[(3, "A0A1B1EFQ0"),],], subsystem = "$subsystem, Arigine Biosynthesis",), #6.3.4.5
    ...
    (rhea_id = 24020, name = "Argininosuccinate lyase", isozymes = [[(1, "A0A1B1EG54"),],], subsystem = "$subsystem, Arigine Biosynthesis",), #4.3.2.1
