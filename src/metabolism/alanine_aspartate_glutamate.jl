...
rxns = (
    ...
    (rhea_id = 15753, name = "Adenylosuccinate synthetase", isozymes = [[(2, "A0A1B1EFK9"),],[(2, "A0A1B1EHC6"),],], subsystem = subsystem,), #6.3.4.4
    ...
    (rhea_id = 30235, name = "Bifunctional protein PutA", isozymes = [[(1, "A0A1B1EHY2"),],], subsystem = subsystem,), #1.2.1.88
    ...
    (rhea_id = 14905, name = "Amidophosphoribosyltransferase", isozymes = [[(1, "A0A1B1EDU7"),],], subsystem = subsystem,), #2.4.2.14
...
(rhea_id = #23920, #16853, name = "Adenylosuccinate lyase", isozymes = [[(1, "A0A1B1EBC6"),],], subsystem = subsystem,), #4.3.2.2
