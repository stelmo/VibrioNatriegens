...
rxns = (
    ...
    (rhea_id = 12641, name = "D-3-phosphoglycerate dehydrogenase", isozymes = [[(1, "A0A1B1EF12"),],], subsystem = subsystem,), #1.1.1.95
    ...
    (rhea_id = 24284, name = "Aspartate-semialdehyde dehydrogenase", isozymes = [[(2, "A0A1B1EDS3"),], [(2, "A0A1B1EDU6"),],], subsystem = subsystem,), #1.2.1.11
...
EC 2.7.2.4 - unclear subunit information (unsure which of 2 enzymes the subunit structure refers to)
    (rhea_id = 23776, name = "Aspartokinase", isozymes = [[("A0A1B1E9N6"),], [("A0A1B1EFF7"),], [(1, "A0A1B1EEX2"),], [(1, "A0A1B1EF89"),],], subsystem = subsystem,),
